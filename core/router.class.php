...
class Router
{
     ...
     * @return string|null
     */
    protected function getURLForRouteDefinition(array $routeDefinition, $controller, $action = null, $namespace = null,
     ...
     * @param string $namespace Namespace of the controller, NULL for default
     ...
     */
    public function URL($controller, $action = null, $namespace = null, $params = array(),
        $escapeAmps = true, $rawurlencode = true)
    {
        ...
        foreach ($this->routeDefinitions as &$routeDefinition) {
            $url = $this->getURLForRouteDefinition($routeDefinition, $controller, $action, $namespace, $params, $amp, $encodeFunction);
            if ($url !== null) {
                return $url;
            }
        }
